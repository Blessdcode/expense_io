...
import { illustration, goggle,ill } from '../../assets'
...
export const Auth = () => {
    ...
    return (
        <div className='flex flex-col items-start md:items-center justify-center ml-6 md:ml-0 my-8'>
            ...
            <div className=''>
                <img src={ill} alt="illutration" className='md:w-[450px] w-full' />
            </div>
            <div className='flex flex-col my-5'>
                <h1 className=' w-4/5 md:w-full text-[38px] md:text-[46px] font-bold text-[#292830]'>Track your Expenses to Save Money</h1>
                <p className='text-[14px] text-left md:text-center text-[#292830]'>Expense.io helps you to organize your income and expenses</p>
            </div>
